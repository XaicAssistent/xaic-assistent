...
export class EventMapper {
    ...
    public static infoEventJSONtoEvent(infoEventJSON){
        let evento: Event = new Event();

        let eve = infoEventJSON['evento'];
        ...
        if(infoEventJSON['userEmpresa']){
            let user = infoEventJSON['userEmpresa'];
            ...
            evento.userEmpresa.direccionFija = <boolean>user["UserEmpresa.drireccion_fija"];
        }
